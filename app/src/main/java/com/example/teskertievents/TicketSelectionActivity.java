...
import com.example.teskertievents.adapters.TicketTypeAdapter;
...
public class TicketSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new TicketTypeAdapter(this, ticketTypes, this::updateTotalPrice);
        ...
        continueButton.setOnClickListener(v -> {
            ...
            // Create map of selected ticket types
            Map<String, Integer> selectedTickets = new HashMap<>();
            for (TicketType type : ticketTypes) {
                if (type.getSelectedQuantity() > 0) {
                    selectedTickets.put(type.getName(), type.getSelectedQuantity());
                }
            }
    ...
    private void updateTotalPrice() {
        totalPrice = 0.0;
        for (TicketType type : ticketTypes) {
            totalPrice += type.getPrice() * type.getSelectedQuantity();
        }
