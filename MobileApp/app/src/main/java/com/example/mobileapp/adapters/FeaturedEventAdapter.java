...
public class FeaturedEventAdapter extends RecyclerView.Adapter<FeaturedEventAdapter.FeaturedEventViewHolder> {
    ...
    public FeaturedEventAdapter(Context context, List<Event> eventList, OnEventClickListener listener) {
    ...
    public static class FeaturedEventViewHolder extends RecyclerView.ViewHolder {
        ImageView eventImage;
        TextView titleText, dateText, venueText;
