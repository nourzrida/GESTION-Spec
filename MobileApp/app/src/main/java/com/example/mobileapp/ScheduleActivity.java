...
public class ScheduleActivity extends AppCompatActivity implements ScheduleAdapter.OnScheduleClickListener {
    ...
    private void loadAllSchedules() {
        ...
        apiService.getUpcomingSchedules().enqueue(new Callback<List<EventSchedule>>() {
            @Override
    ...
    private void createMockSchedules() {
        ...
        // Create mock schedules for different venues and events
        String[] venues = {
        ...
        int[] availableSeats = {
                750, 200, 350, 0, 120, 1500
        };

        int[] totalSeats = {
                1000, 500, 400, 800, 200, 2000
        };
        ...
        for (int i = 0; i < venues.length; i++) {
            ...
            schedule.setId(i + 1);
            schedule.setEventId(i % 3 + 1); // Cycle through 3 events
        ...
        apiService.getEvent(schedule.getEventId()).enqueue(new Callback<Event>() {
            ...
            public void onResponse(Call<Event> call, Response<Event> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Intent intent = new Intent(ScheduleActivity.this, TicketSelectionActivity.class);
                    intent.putExtra("event", event);
                    intent.putExtra("schedule", schedule);
                    startActivity(intent);
                } else {
                    Toast.makeText(ScheduleActivity.this, "Failed to load event details", Toast.LENGTH_SHORT).show();
                }
            }
